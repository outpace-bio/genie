...
from genie.data.dataset import SCOPeDataset, EnzymeCommission
...
class EnzymeCommissionDataModule(LightningDataModule):
	...
	def setup(self, stage=None):
		...
		# create dataset
		self.dataset = EnzymeCommission(self.data_dir, min_n_res=self.min_n_res, max_n_res=self.max_n_res, splits=['train'])
